...
extension UIColor {
    ...
    static let specialLightBrown = #colorLiteral(red: 0.5961359615, green: 0.5824904518, blue: 0.5257592207, alpha: 1)
    static let specialBrown = #colorLiteral(red: 0.5058823824, green: 0.3372549117, blue: 0.06666667014, alpha: 1)
